class UMSWeap_Rife95 extends UMSWeapon;
...
//  FireCameraAnim(0)=CameraAnim''
    ...
    AttachmentClass=Class'UMSAttach_Rife95'
...
//  FlashLightSwitchSnd=SoundCue''
	...
	Begin Object Name=FirstPersonMesh
		SkeletalMesh=SkeletalMesh'MyPackage.WP_95.Rifle_95_1P'       //µЏ“ї»Ћ≥∆µƒќд∆ч
        AnimSets(0)=AnimSet'MyPackage.WP_95.Rife_95_1P_anim'                  //ќд∆чµƒґѓї≠animset
  ...
  Mesh=FirstPersonMesh
	*/
	...
	ArmsAnimSet = AnimSet'MyPackage.CH_FPS.Hand_Anim'
	ArmFireAnim(0) = WeaponFire
	ArmFireAnim(1) = WeaponFire
	ArmsPutDownAnim=ArmRifle95PutdownFront
	ArmsEquipAnim="ArmRifle95EquipFront"
	ArmIdleAnims(0)="WeaponIdle"
	ArmIdleAnims(1)="WeaponIdle"

    Begin Object Name=PickupMesh 
      SkeletalMesh=SkeletalMesh'MyPackage.WP_95.Rifle_95_3P'          //WeaponPickupFactoryќд∆ч≥ц…ъµгµƒќд∆ч
    End Object
