...
class UMSFamilyInfo_IronGuard extends UTFamilyInfo
	abstract;
...
defaultproperties
{
  ...
  ArmMesh=SkeletalMesh'CH_Corrupt_Arms.Mesh.SK_CH_Corrupt_Arms_MaleA_1P' 
	...
	HeadShotEffect=ParticleSystem'MyPackage.Effects.P_FX_GibExplode_Corrupt'

	BloodSplatterDecalMaterial=MaterialInstanceTimeVarying'T_FX.DecalMaterials.MITV_FX_OilDecal_Small01'

	GibExplosionTemplate=ParticleSystem'MyPackage.Effects.P_FX_GibExplode_Corrupt'
