class UMSAttach_Rife95 extends UMSWeaponAttachment;


simulated function AttachTo(UTPawn OwnerPawn)
{
	if(UMSPawn(Owner).bUseSecondary)
	{
		return;
	}
	super.AttachTo(OwnerPawn);
	OwnerPawn.SetWeapAnimType(EWAT_Pistol); 
}
...
DefaultProperties
{
  // Weapon SkeletalMesh
	Begin Object Name=SkeletalMeshComponent0
		SkeletalMesh=SkeletalMesh'MyPackage.WP_95.Rifle_95_3P'//非第一人称的武器
		Translation=(Y=0,Z=-2)
